...
/**
 * Carbon Security LDAP connector OSGi tests.
 */
...
class StoreTests {
    ...
    static final String DEFAULT_CREDENTIAL_STORE = "LDAPCredentialStore";
    static final String DEFAULT_AUTHORIZATION_STORE = "LDAPAuthorizationStore";
